...
This module provides the FastAPI application for the payment service
...
from src.payment_service.routers import transaction_router, wallet_router
...
def create_application() -> FastAPI:
    ...
    app = FastAPI(
        ...
        version="0.1.0",
        description="Payment Service for PalmsGig Social Media Task Marketplace",
